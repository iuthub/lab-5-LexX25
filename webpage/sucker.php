...
<html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <body>
    <?php
    if(isset($_REQUEST['name']) && isset($_REQUEST['selection']) && isset($_REQUEST['Card']) && isset($_REQUEST["cardType"])){
    ?>
        <?php
        $file = 'suckers.txt';

        $current = file_get_contents($file);
        $current .= $_POST['name'] . ';' . $_POST['selection'] . ';' . $_POST['Card'] . ';' . $_POST['cardType'] . "\n";
